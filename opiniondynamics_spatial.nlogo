...
to-report check-consensus
  ...
  report opinion-difference < 0.05
end

to-report time-to-consensus
  ifelse check-consensus [report ticks] [report -1]
end
...
* Smaldino PE (2023). Opinion Dynamics: Positive Influence. Modeling Social Behavior.  https://github.com/psmaldino/modsoc/
...
@#$#@#$#@
<experiments>
  <experiment name="non-spatial" repetitions="5" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="200000"/>
    <metric>time-to-consensus</metric>
