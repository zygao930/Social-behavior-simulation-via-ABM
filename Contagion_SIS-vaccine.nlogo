...
;;This model adds recovery, so agents can dis-adopt.
...
* Smaldino PE (2023). Contagion: SIS. Modeling Social Behavior.  https://github.com/psmaldino/modsoc/
