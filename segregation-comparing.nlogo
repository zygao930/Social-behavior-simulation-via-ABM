...
1402
417
average-similarity and prop-uniform
time
NIL
0.0
20.0
...
"" ""
PENS
"average-similarity" 1.0 0 -5298144 true "" "plot average-similarity"
"prop-uniform" 1.0 0 -14454117 true "" "plot prop-uniform"
...
@#$#@#$#@
<experiments>
  <experiment name="Segregation" repetitions="5" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="100"/>
    <metric>average-similarity</metric>
    <metric>unhappiness</metric>
    <steppedValueSet variable="density" first="0.15" step="0.15" last="0.75"/>
    <steppedValueSet variable="similarity-threshold" first="0.45" step="0.45" last="0.9"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
