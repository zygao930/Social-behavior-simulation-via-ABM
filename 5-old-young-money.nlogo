...
333
496
Degree Distribution (log-log) for YOUNG/GREEN turtles
log(degree)
log(# of nodes)
0.0
0.3
...
"" ""
PENS
"default" 1.0 0 -14439633 true "" "let green-turtles turtles with [color = green]\n\nif not plot? [ stop ]\nlet max-degree max [count link-neighbors] of turtles\n;; for this plot, the axes are logarithmic, so we can't\n;; use \"histogram-from\"; we have to plot the points\n;; ourselves one at a time\nplot-pen-reset  ;; erase what we plotted before\n;; the way we create the network there is never a zero degree node,\n;; so start plotting at degree one\nlet degree 1\nwhile [degree <= max-degree] [\n  let matches green-turtles with [count link-neighbors = degree]\n  if any? matches\n    [ plotxy log degree 10\n             log (count matches) 10 ]\n  set degree degree + 1\n]"
...
333
329
Degree Distribution for YOUNG/GREEN turtles
degree
# of nodes
1.0
10.0
...
"" ""
PENS
"default" 1.0 1 -12087248 true "" "let green-turtles turtles with [color = green]\n\nif not plot? [ stop ]\nlet max-degree max [count link-neighbors] of turtles\nplot-pen-reset  ;; erase what we plotted before\nset-plot-x-range 1 (max-degree + 1)  ;; + 1 to make room for the width of the last bar\nhistogram [count link-neighbors] of green-turtles"
...
676
329
Degree Distribution for OLD/RED turtles
degree
# of nodes
0.0
10.0
...
"" ""
PENS
"default" 1.0 1 -2674135 true "" "let red-turtles turtles with [color = red]\n\nif not plot? [ stop ]\nlet max-degree max [count link-neighbors] of red-turtles\nplot-pen-reset  ;; erase what we plotted before\nset-plot-x-range 1 (max-degree + 1)  ;; + 1 to make room for the width of the last bar\nhistogram [count link-neighbors] of red-turtles"
...
676
497
Degree Distribution (log-log) for OLD/RED turtles
log(degree)
log(# of nodes)
0.0
10.0
...
"" ""
PENS
"default" 1.0 0 -5298144 true "" "let red-turtles turtles with [color = red]\n\nif not plot? [ stop ]\nlet max-degree max [count link-neighbors] of turtles\n;; for this plot, the axes are logarithmic, so we can't\n;; use \"histogram-from\"; we have to plot the points\n;; ourselves one at a time\nplot-pen-reset  ;; erase what we plotted before\n;; the way we create the network there is never a zero degree node,\n;; so start plotting at degree one\nlet degree 1\nwhile [degree <= max-degree] [\n  let matches red-turtles with [count link-neighbors = degree]\n  if any? matches\n    [ plotxy log degree 10\n             log (count matches) 10 ]\n  set degree degree + 1\n]"
